    ...
    return (<div style={{ width: '100%' }}>
        ...
        <div style={{ width:  matches4?'98%':'90%' ,background:'white',display:'flex',alignItems:'center',flexDirection:'column',borderRadius:20}}>
            <div style={{ width: '95%', height:matches4?200: 250,marginTop:18 ,borderRadius:20}}>
               ...
               {userid == userData?._id ? <Button style={{position:'absolute',color:'#7f8c8d',left:matches5?'84%':matches4?'87%':matches3?'86%':matches2?'56%':'57.5%',top:matches5?'12%':matches3?'12.5%':matches2?'9%':'9%', padding:0}} component="label" > 
                <ModeEditIcon  />
